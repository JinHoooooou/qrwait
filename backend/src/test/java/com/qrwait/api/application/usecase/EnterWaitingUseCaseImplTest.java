...
class EnterWaitingUseCaseImplTest {
  ...
  private EnterWaitingUseCaseImpl useCase;

  @BeforeEach
  void setUp() {
    useCase = new EnterWaitingUseCaseImpl(waitingRepository, storeRepository);
  }

  @Test
  void execute_정상_입장처리() {
