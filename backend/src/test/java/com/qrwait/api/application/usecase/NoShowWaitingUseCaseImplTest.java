...
class NoShowWaitingUseCaseImplTest {
  ...
  private NoShowWaitingUseCaseImpl useCase;

  @BeforeEach
  void setUp() {
    useCase = new NoShowWaitingUseCaseImpl(waitingRepository, storeRepository);
  }

  @Test
  void execute_정상_노쇼처리() {
